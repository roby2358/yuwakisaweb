...
export const TERRAIN = {
    ...
    FOREST: 4,
    QUARRY: 5,
    // Prize hexes — lighter-tinted "special" versions of the base terrain.
    SPECIAL_PLAINS: 6,
    SPECIAL_FOREST: 7,
    SPECIAL_HILLS: 8,
    SHATTERED_PLAINS: 9,
    ...
    SHATTERED_FOREST: 11,
    SHATTERED_QUARRY: 12,
    DISTRESSED_PLAINS: 13,
    DISTRESSED_HILLS: 14,
    DISTRESSED_FOREST: 15,
...
export const RANGER_TERRAIN = [
    ...
    TERRAIN.SPECIAL_FOREST, TERRAIN.SPECIAL_HILLS,
...
export const TERRAIN_NAMES = {
    ...
    [TERRAIN.SPECIAL_PLAINS]: 'Verdant Glade',
    [TERRAIN.SPECIAL_FOREST]: 'Hallowed Grove',
    [TERRAIN.SPECIAL_HILLS]: 'Gilded Rise',
...
export const MOVEMENT_COST = {
    ...
    [TERRAIN.FOREST]: 2,
    [TERRAIN.QUARRY]: 2,
    [TERRAIN.SPECIAL_PLAINS]: 1,
    [TERRAIN.SPECIAL_FOREST]: 2,
    [TERRAIN.SPECIAL_HILLS]: 2,
