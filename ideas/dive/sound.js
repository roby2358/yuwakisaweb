...
const GameSound = (function () {
    ...
    const LOW = SCALE.slice(0, 2);     // bottom of the scale — danger rumbles
    ...
    class GameSound {
        ...
        gather() { this.phrase([SCALE[3]]); }                    // one plink per unit pried loose
        coin() { this.phrase([SCALE[5], SCALE[7]]); }            // sold / crafted at market
        danger() { this.phrase(randomNotes(LOW, 2)); }           // maul, blackout, wake
        bite() { this.phrase([LOW[1], LOW[0], LOW[0]]); }        // hull hit / sub down
    }
