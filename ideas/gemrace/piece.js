...
// every positioned token — the player, home city, and monsters today; the units,
...
// it server-side; no display artifacts here. A piece's *intrinsic* color (a monster's seeded
...
class Piece {
    constructor(q, r, color, label) {
        this.q = q;
        this.r = r;
        this.color = color;   // intrinsic color (monsters); null when drawn with a display constant
        this.label = label;   // single-glyph counter label ('P', 'M', '⌂')
    }
