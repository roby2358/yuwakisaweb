...
const GameSound = (function () {
    ...
    class GameSound {
        ...
        build() { this.phrase([SCALE[1], SCALE[3], SCALE[5]]); } // rising: something raised
        recruit() { this.phrase([SCALE[3], SCALE[6]]); }         // a bright hello
        shoo() { this.phrase([SCALE[0], SCALE[4]]); }            // low growl, high yelp
        smash() { this.phrase([SCALE[1], SCALE[0]]); }           // falling: something lost
    }
