...
// core.js — the core game: tables and rules from the official En Garde!
// reference tables (www.engarde.co.uk). Everything in this file traces to
// the published game. Solo-play inventions and house rules live in data.js;
// deliberate deviations are listed in README.md. MIT License, see LICENSE.
...
// Friendships and enmities are an adaptation: see REGIMENT_RELATIONS in data.js.
const REGIMENTS = [
  { id: 'rfg', name: 'Royal Foot Guards', brigade: 'Brigade of Guards', column: 0, cavalry: false, firstSL: 7, mods: { death: 3, mention: 0, promotion: 1, crowns: -2 } },
  { id: 'cg', name: "Cardinal's Guard", brigade: 'Brigade of Guards', column: 1, cavalry: false, firstSL: 6, mods: { death: 2, mention: 0, promotion: 0, crowns: -1 } },
  { id: 'km', name: "King's Musketeers", brigade: 'Brigade of Guards', column: 1, cavalry: false, firstSL: 6, mods: { death: 2, mention: -1, promotion: 0, crowns: -1 } },
  { id: 'dg', name: 'Dragoon Guards', brigade: 'Horse Guards Brigade', column: 2, cavalry: true, firstSL: 5, mods: { death: 2, mention: -1, promotion: 0, crowns: -1 } },
  { id: 'qoc', name: "Queen's Own Carabiniers", brigade: 'Horse Guards Brigade', column: 3, cavalry: true, firstSL: 4, mods: { death: 2, mention: 0, promotion: 0, crowns: 0 } },
  { id: 'alc', name: 'Archduke Leopold Cuirassiers', brigade: 'Heavy Brigade', column: 3, cavalry: true, firstSL: 4, mods: { death: 2, mention: 0, promotion: 0, crowns: 0 } },
  { id: 'cpc', name: 'Crown Prince Cuirassiers', brigade: 'Heavy Brigade', column: 4, cavalry: true, firstSL: 3, mods: { death: 1, mention: -1, promotion: -1, crowns: 0 } },
  { id: 'rm', name: 'Royal Marines', brigade: '1st Brigade of Foot', column: 5, cavalry: false, firstSL: 2, mods: { death: 1, mention: 0, promotion: 0, crowns: 0 } },
  { id: 'gdm', name: "Grand Duke Max's Dragoons", brigade: 'Dragoon Brigade', column: 5, cavalry: true, firstSL: 2, mods: { death: 1, mention: 0, promotion: 0, crowns: 0 } },
  { id: 'pm', name: 'Picardy Musketeers', brigade: '1st Brigade of Foot', column: 6, cavalry: false, firstSL: 1, mods: { death: 0, mention: 0, promotion: 1, crowns: 0 } },
  { id: '13f', name: '13th Fusiliers', brigade: '2nd Brigade of Foot', column: 7, cavalry: false, firstSL: 0, mods: { death: 0, mention: 0, promotion: 0, crowns: 0 } },
  { id: 'plld', name: "Princess Louisa's Light Dragoons", brigade: 'Dragoon Brigade', column: 7, cavalry: true, firstSL: 0, mods: { death: 0, mention: 0, promotion: 0, crowns: 0 } },
  { id: '53f', name: '53rd Fusiliers', brigade: '2nd Brigade of Foot', column: 8, cavalry: false, firstSL: -1, mods: { death: 0, mention: 0, promotion: 0, crowns: 0 } },
  { id: '27m', name: '27th Musketeers', brigade: '3rd Brigade of Foot', column: 8, cavalry: false, firstSL: -1, mods: { death: 0, mention: 0, promotion: 0, crowns: 0 } },
  { id: '4a', name: '4th Arquebusiers', brigade: '3rd Brigade of Foot', column: 8, cavalry: false, firstSL: -1, mods: { death: 0, mention: 0, promotion: 0, crowns: 0 } },
  { id: '69a', name: '69th Arquebusiers', brigade: '4th Brigade of Foot', column: 9, cavalry: false, firstSL: -2, mods: { death: -1, mention: 0, promotion: 1, crowns: -2 } },
  { id: 'gascon', name: 'The Gascon Regiment', brigade: '4th Brigade of Foot', column: 9, cavalry: false, firstSL: -2, mods: { death: -1, mention: 0, promotion: 1, crowns: -2 } },
  { id: 'frontier', name: 'The Frontier Regiment', brigade: 'The Frontier', column: 9, cavalry: false, firstSL: -99, mods: { death: -1, mention: 0, promotion: 1, crowns: -1 } },
];
