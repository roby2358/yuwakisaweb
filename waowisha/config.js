...
export const STRUCTURE_TYPES = {
    ...
    spike:       { name: 'Spike',         category: 'defense', cost: { R0d: 1 },  buildTime: 1, range: 3, power: 1, targeting: 'weakest' },
    watchPost:   { name: 'Watch Post',    category: 'defense', cost: { R0d: 2, R0c: 1 }, buildTime: 2, range: 3, power: 2, targeting: 'strongest' },
